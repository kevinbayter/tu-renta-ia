...
const PERFIL_DORADO: PerfilFiscal = {
  ...
  rentasCapital: {
    // Banco Ejemplo 786.273 + FIC Ejemplo Dos 6.103 (base componente inflacionario)
    rendimientosConComponente: 792_376,
    // Rendimientos de cesantías AFP Ejemplo (sin componente inflacionario)
  ...
  patrimonio: {
    activos: [
      ...
      { descripcion: 'Banco Ejemplo cuenta ahorros', valor: 20_902_486 },
