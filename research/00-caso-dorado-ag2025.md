...
- Ingresos: **1.175.000** (= Banco Ejemplo rendimientos 786.273 + rendimientos cesantías AFP Ejemplo 382.694 + FICs Ejemplo Dos 6.103 + Fiduciaria Uno ~471 + Fiduciaria Tres 47.272 → referencia usó 786.000 + 383.000 + 6.000)
- INCRNGO componente inflacionario **55,43%**: 439.000 (sobre 786.000+6.000, no sobre rendimientos de cesantías)
- Deducción GMF 50%: 17.000 (Banco Ejemplo GMF 2.019… referencia reporta GMF total 34.913 → 50% = 17.457 ≈ 17.000)
...
5. `Retefuente_…unlocked.pdf` — Banco Ejemplo: saldo 20.902.486, rendimientos 786.273, GMF 2.019, ret. 42.541, componente inflacionario 435.831 (55,43%).
