...
| ---------------------------- | ------------ | ---------- |
| App "Sin afán"               | $170.000     | hasta 24 h |
| App "Exprés"                 | $470.000     | mismo día  |
| Experto WhatsApp             | $199.000     | 48 h       |
| Experto "Sin afán"           | $250.000     | 2+ días    |
| Experto telefónico           | $239.000     | estándar   |
...
## 2. Competidores en Colombia

Panoramas: [Infobae](https://www.infobae.com/colombia/2024/05/28/declaracion-de-renta-en-colombia-plataformas-online-que-facilitan-y-agilizan-su-tramite/), [La República](https://www.larepublica.co/finanzas/conozca-las-plataformas-online-disponibles-que-lo-ayudan-con-su-declaracion-de-renta-4180100), [El Colombiano](https://www.elcolombiano.com/negocios/plataformas-para-hacer-declaracion-de-renta-JP28144094).

| Competidor                                                                                      | Qué ofrece                                                                                                                             | Precio                                           | Diferenciador                                                                                                 |
| ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------- |
| **[Contadia](https://www.contadia.com/)**                                                       | Liquidador online del 210: conexión DIAN → exógena precargada, motor tributario, 490 y link de pago. **Dirigido a contadores** (B2B2C) | 1.ª gratis; ilimitado **$270.000/año**           | Exógena "en <15 min", chatbot "Gurú" 24/7 WhatsApp, garantía, [alianza Siigo](https://www.contadia.com/siigo) |
| **DeclaraYa**                                                                                   | Declaración en <48 h                                                                                                                   | n.d.                                             | Velocidad                                                                                                     |
| **TuDeclaración**                                                                               | Desde 2014; formulario web + 48 h                                                                                                      | n.d.                                             | Antigüedad                                                                                                    |
| **TuImpuesto**                                                                                  | Guía didáctica + presentación o contador                                                                                               | n.d.                                             | Educativo                                                                                                     |
| **Contalisto**                                                                                  | Firma ~10 años; PN y pymes                                                                                                             | n.d.                                             | Tradicional digitalizado                                                                                      |
| **[SaraDeclara](https://saradeclara.com)**                                                      | Cuestionario guiado + **lectura automática de archivos DIAN**, cálculo y reporte explicado                                             | **$59.900** / $119.900 / $249.900 (con contador) | El más barato; el más parecido a tesis "AI-first"                                                             |
| **[Cifrato.ai](https://cifrato.ai/blog/cuanto-cobra-un-contador-por-una-declaracion-de-renta)** | Copiloto contable IA para contadores                                                                                                   | n.d.                                             | IA B2B                                                                                                        |
| **Contadores tradicionales**                                                                    | $150.000–$400.000 simple; $400–700 mil medio; $1,2–3,5M complejo/exterior                                                              | —                                                | Confianza personal                                                                                            |
| **Alegra / Siigo**                                                                              | No venden renta PN directo al consumidor; Siigo canaliza a Contadia                                                                    | —                                                | Canal potencial                                                                                               |

No hay evidencia relevante de "Taxia", "Ntábilo", "declarante.com.co" ni "DR Group". PwC tiene servicio corporativo (People Tax).

### La opción gratuita (el verdadero competidor #1): DIAN

- **Declaración sugerida**: F210 pre-llenado con exógena + facturación electrónica; revisar, ajustar y presentar gratis en Muisca ([micrositio DIAN AG-2025](https://micrositios.dian.gov.co/renta-personas-naturales-ag-2025/preparese-para-la-declaracion/)).
- **Programa Ayuda Renta**: Excel gratuito DIAN.
- 2025-2026: Muisca reforzado + avatar "Diana" ([Infobae](https://www.infobae.com/colombia/2026/07/21/la-dian-reforzo-sus-herramientas-digitales-para-la-declaracion-de-renta-del-ano-gravable-2025-asi-puede-obtener-ayuda-en-la-plataforma-de-la-entidad/)).
- **Implicación**: la sugerida erosiona el segmento más simple. El valor defendible: optimización (la sugerida NO optimiza deducciones), casos con múltiples fuentes/exterior/cripto, garantía, quitar miedo/tiempo. Advertencias de expertos contra confiar ciegamente en la sugerida o IA genérica: [OCH Group](https://www.ochgroup.co/en/estas-pensando-en-hacer-tu-declaracion-de-renta-con-la-declaracion-sugerida-por-la-dian-o-con-la-inteligencia-artificial-ia-lee-este-articulo-antes-de-tomar-la-decision/), [Noticias RCN](https://www.noticiasrcn.com/economia/declarar-renta-con-inteligencia-artificial-beneficios-y-errores-957263), [Actualícese](https://actualicese.com/ia-al-servicio-de-la-declaracion-de-renta-lo-que-toda-persona-natural-debe-saber-hoy/).
...
**Conclusión**: nadie en Colombia tiene un producto consumer verdaderamente LLM-native (extracción automática de certificados PDF + entrevista conversacional + explicaciones). Contadia y SaraDeclara automatizan exógena/archivos DIAN, pero el patrón Intuit/Taxfix está libre.
...
1. **Pagar antes de ver el resultado** → Oportunidad: modelo Taxfix — entrevista y cálculo gratis, paga solo para descargar/presentar.
2. **Precio en ascenso y castigo por urgencia** ($470–550K por entrega hoy; 2.7x) → si la IA elimina el cuello humano, entrega inmediata estándar sin sobreprecio (SaraDeclara ancla $59.900).
3. **Carga manual de certificados** guiada por artículos de ayuda; el plan experto lo resuelve con humanos (300 asesores estacionales, caro de escalar) → **Oportunidad central IA: subir PDFs/fotos de cualquier certificado y que un LLM extraiga, clasifique y concilie contra la exógena**, con entrevista conversacional en vez de formularios.
4. **Soporte saturado en pico** → asistente IA 24/7 con escalamiento a contador.
5. **Entrega de credenciales DIAN a un tercero** (fricción de confianza) → flujo donde el usuario sube él mismo el Excel de exógena y la IA lo interpreta.
6. **Sin relación anual** → planeación tributaria continua (retenciones, AFC, pensión voluntaria durante el año), modelo "year-round" de Intuit/april; solución a la estacionalidad.
7. **Confiabilidad como barrera** ([Semana — ¿son confiables?](https://www.semana.com/impuestos/articulo/que-tan-confiables-son-las-aplicaciones-para-declarar-renta/76989/)) → igualar la garantía anti-sanciones + revisión humana/contador visible.
