...
- **Cachear el prompt del sistema** (reglas de la entrevista + estado fiscal): con prompt caching (Kimi, DeepSeek, OpenAI, Gemini) el costo de una conversación de 30 turnos cae 80-90%.
...
| **Premium** | Extracción: gpt-5.6-terra ($2.50/$15); entrevista: gpt-5.6-luna ($1/$6) con prompt caching                                                       | **~US$1.20–2.50** (≈ COP 5.000–10.000)                                 |
