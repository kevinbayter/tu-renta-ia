...
2. Por lo tanto, la "conexión con la DIAN" de las plataformas del mercado (Contadia y similares) para **descargar exógena** y para **presentar el 210** es, casi con certeza, **automatización del portal MUISCA (RPA / scraping con navegador headless) usando las credenciales del propio usuario** (tipo y número de documento + contraseña). No es OAuth ni un API oficial. **[Inferencia fuerte, no confirmada por las empresas]**

3. La cobertura legal es el **mandato** (art. 572 y 572-1 del Estatuto Tributario): el usuario autoriza a la plataforma de referencia o al experto a actuar y firmar en su nombre. Esto es lo que evita que caiga bajo la Ley 1273 de 2009 (acceso abusivo a sistema informático): hay **autorización del titular**. **[Documentado]**

4. La plataforma de referencia tiene **dos modelos**: en el plan "hazlo tú mismo" **el usuario transcribe y presenta** en el portal DIAN; en el plan asistido **un experto presenta la declaración directamente ante la DIAN** por el usuario. **[Documentado]**
...
- La plataforma de referencia: _"puedes conectarte con tu cuenta de la DIAN para que se cargue directamente en nuestra plataforma la información exógena tributaria que tienes reportada allí"_. **[Documentado]**
  Fuente:
...
- **Alternativa documentada y explícita**: la plataforma de referencia también permite que el usuario **descargue el archivo manualmente y lo suba** a la plataforma (_"en la plataforma de referencia te pediremos el documento de la información exógena"_). Esto significa que la "conexión" automática es un **conveniencia opcional**, no un requisito. **[Documentado]**
...
- **La plataforma de referencia, plan asistido:** _"un experto generará tu declaración... te entrega un borrador para tu aprobación y luego presenta la declaración directamente a la DIAN"_ / _"el experto presenta tu declaración ante la DIAN por ti"_. **[Documentado]**
- **La plataforma de referencia, plan "hazlo tú mismo":** el usuario entra al portal DIAN con su usuario y contraseña, elige "Diligenciar y Presentar Formulario 210", **transcribe** las casillas que la plataforma de referencia le entrega, y firma/presenta él mismo. **[Documentado]**
  Fuente: (título "¿Cómo presentar la declaración de renta?")
- **Firma electrónica:** la plataforma de referencia indica _"Debes contar con firma electrónica en la DIAN, o de lo contrario, darnos la autorización para que te generemos una"_. **[Documentado]** — es decir, si el usuario no tiene IFE, **la plataforma de referencia la genera/habilita en su nombre** (otra operación automatizada en el MUISCA).
...
En la práctica, el "botón de presentar" de las plataformas del mercado se sostiene jurídicamente en un **mandato/autorización** que el usuario acepta en los términos de servicio.
...
- **Habeas Data (Ley 1581 de 2012):** tratamiento de datos personales y credenciales exige autorización, finalidad limitada y medidas de seguridad. La plataforma de referencia declara cifrado "con los más altos estándares" y no compartir con terceros no autorizados. **[Documentado]**
...
- **La plataforma de referencia:** conexión para cargar exógena + presentación asistida por experto (plan pago) o autoservicio (el usuario presenta). **[Documentado]**
...
4. **Aislar la operación de firma/presentación** detrás de una confirmación explícita del usuario sobre el borrador (como hacen los competidores), para no presentar sin aprobación.
...
- La plataforma de referencia: exógena · cómo presentar · firma electrónica · planes
