...
| Doc                                                                            | Contenido                                                                                                                                                                                                                                                  |
| ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [00-caso-dorado-ag2025.md](00-caso-dorado-ag2025.md)                           | Caso de prueba real (declaración AG2025 real elaborada con referencia): entradas, depuración completa y resultado esperado ($1.401.000 saldo a favor). Nuestra plataforma debe reproducirlo exactamente.                                                      |
